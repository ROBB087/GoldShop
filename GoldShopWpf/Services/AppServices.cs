...
public static class AppServices
{
    ...
    public static void Initialize()
    {
        ...
        DiscountService = new DiscountService(discountRepository, transactionRepository, traderSummaryRepository, AuditService, CacheService);
        ...
        ReportService = new ReportService(supplierRepository, transactionRepository, discountRepository);
